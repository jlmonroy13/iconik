...
export function AppointmentsSection({ appointments, stats }: AppointmentsSectionProps) {
  ...
  return (
    <DashboardSectionLayout
      ...
      actionButton={
        <Button onClick={handleCreate} variant="primary" className="w-full sm:w-auto flex items-center gap-2">
