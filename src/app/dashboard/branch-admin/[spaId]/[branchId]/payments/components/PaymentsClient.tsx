...
export function PaymentsClient({
  ...
  const handleClearFilters = () => {
    ...
    setMinAmount('');
    setMaxAmount('');
    router.push(`/dashboard/branch-admin/${spaId}/${branchId}/payments?page=1`);
  };
  ...
  const handleViewPayment = (payment: PaymentListItem) => {
            ...
            <div className="text-center py-12">
              ...
              <p className="text-gray-500 dark:text-gray-400">
                {hasActiveFilters
                  ...
                  : 'Aún no hay pagos registrados en esta sede.'}
              </p>
            </div>
          ) : (
            <>
              <PaymentTable payments={payments} onView={handleViewPayment} />
