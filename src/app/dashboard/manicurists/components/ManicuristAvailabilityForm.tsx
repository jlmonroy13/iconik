  ...
  return (
    <div className="space-y-4">
      ...
      <p className="text-sm text-gray-600 dark:text-gray-400">
        Configura días específicos como vacaciones, días libres, o horarios especiales
      </p>
      ...
      {fields.length === 0 && (
        <div className="text-center py-8 text-gray-500 dark:text-gray-400">
          ...
          <p className="text-sm">Agrega vacaciones, días libres o horarios especiales</p>
        </div>
      )}
            ...
            <div key={field.id} className="border border-gray-200 dark:border-gray-700 rounded-lg p-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                <Input
                  label="Fecha"
                  type="date"
                  value={currentAvailability?.date ? formatDate(currentAvailability.date) : ''}
                  onChange={(e) => {
                    updateAvailabilityField(index, 'date', new Date(e.target.value))
                  }}
                ...
                <div className="flex items-center gap-2">
                  <label className="flex items-center gap-2">
                    <input
                      ...
                      onChange={(e) => {
                        updateAvailabilityField(index, 'isAvailable', e.target.checked)
                      }}
              ...
              {currentAvailability?.isAvailable && (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                  <Input
                    ...
                    onChange={(e) => {
                      updateAvailabilityField(index, 'startTime', e.target.value)
                    }}
              ...
              <div className="mt-3 p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
                <div className="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400">
                  ...
                  <span>
                    {currentAvailability?.isAvailable ? 'Disponible' : 'No disponible'}
