...
export function ManicuristClientWrapper({
  ...
  const handleEdit = useCallback((manicurist: Manicurist) => {
  ...
  return (
    <PageTransition className="h-full">
      ...
      <div className="mt-6">
        {filteredManicurists.length === 0 ? (
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-8 text-center">
            <p className="text-gray-500 dark:text-gray-400">No hay manicuristas registradas.</p>
          </div>
        ) : (
      ...
      <ConfirmDialog
        ...
        description={manicuristToDelete ? `¿Estás seguro de que deseas eliminar a ${manicuristToDelete.name}? Esta acción no se puede deshacer.` : ''}
