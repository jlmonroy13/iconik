...
import {
  manicuristFormSchema,
  type ManicuristFormData,
  ManicuristScheduleData,
  ManicuristAvailabilityData,
} from '../schemas';
...
export function ManicuristForm({
  manicurist,
  onSubmit,
  services,
  selectedServices,
  ...
  const methods = useForm<ExtendedManicuristFormData>({
    ...
    defaultValues: manicurist
      ? {
          ...
          commission:
            typeof manicurist.commission === 'number'
              ? manicurist.commission * 100
              : 50,
