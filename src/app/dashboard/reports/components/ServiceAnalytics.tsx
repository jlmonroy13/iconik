...
export function ServiceAnalytics({ services }: ServiceAnalyticsProps) {
  ...
  const getServiceTypeColor = (serviceType: string) => {
    const colors = {
      MANICURE: 'bg-pink-100 text-pink-800 dark:bg-pink-900/20 dark:text-pink-300',
      PEDICURE: 'bg-blue-100 text-blue-800 dark:bg-blue-900/20 dark:text-blue-300',
      NAIL_ART: 'bg-purple-100 text-purple-800 dark:bg-purple-900/20 dark:text-purple-300',
      GEL_POLISH: 'bg-yellow-100 text-yellow-800 dark:bg-yellow-900/20 dark:text-yellow-300',
      ACRYLIC_NAILS: 'bg-green-100 text-green-800 dark:bg-green-900/20 dark:text-green-300',
      NAIL_REPAIR: 'bg-orange-100 text-orange-800 dark:bg-orange-900/20 dark:text-orange-300',
      HAND_SPA: 'bg-indigo-100 text-indigo-800 dark:bg-indigo-900/20 dark:text-indigo-300',
      FOOT_SPA: 'bg-teal-100 text-teal-800 dark:bg-teal-900/20 dark:text-teal-300',
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-base sm:text-lg">Distribución por Tipo de Servicio</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-base sm:text-lg">Rendimiento por Servicio</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-base sm:text-lg">Detalle Completo de Servicios</CardTitle>
        </CardHeader>
        <CardContent>
