...
export async function updateSpaSettings(data: SpaSettingsFormValues) {
  try {
    ...
    return {
      success: false,
      message:
        'No se pudo actualizar la configuración del spa. Inténtalo de nuevo.',
    };
  }
}
...
export async function updateOperatingHours(data: OperatingHoursFormValues) {
  try {
    ...
    return {
      success: false,
      message:
        'No se pudo actualizar los horarios de operación. Inténtalo de nuevo.',
    };
  }
}
...
export async function updateGeneralPreferences(/* data: GeneralPreferencesFormValues */) {
  try {
    ...
    return {
      success: false,
      message:
        'No se pudo actualizar las preferencias generales. Inténtalo de nuevo.',
    };
  }
}
...
export async function getSpaSettings() {
  try {
    ...
    const spa = await prisma.spa.findUnique({
      ...
      select: {
        ...
        spaSchedules: {
          ...
          orderBy: [{ isHoliday: 'asc' }, { dayOfWeek: 'asc' }],
        },
      },
    });
    ...
    return {
      success: false,
      message:
        'No se pudo cargar la configuración del spa. Inténtalo de nuevo.',
    };
  }
}
...
export async function updateSpaSchedule(
  id: string,
  data: Partial<SpaScheduleInput>
) {
  try {
    const spaId = await getSpaId();
...
export async function updateSalesGoal(
  ...
  try {
    ...
    if (data.manicuristId !== undefined)
      updateData.manicuristId = data.manicuristId || null;
