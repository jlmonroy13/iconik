...
import { OperatingHoursSchema, type OperatingHoursFormValues } from '../schemas'
import {
  Button,
  Input,
  useNotifications,
...
export function OperatingHoursForm({ openingTime, closingTime }: OperatingHoursFormProps) {
