...
export function SchedulePreview({ schedules }: SchedulePreviewProps) {
  const getDayLabel = (
    dayOfWeek: number | undefined | null,
    isHoliday: boolean
  ) => {
    ...
    <div className='space-y-4'>
      ...
      <div className='mt-4 p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg'>
        <p className='text-sm text-blue-800 dark:text-blue-200'>
          💡 <strong>Consejo:</strong> Los horarios configurados aquí se usarán
          para determinar la disponibilidad de citas y mostrarán a los clientes
          cuándo está abierto tu spa.
        </p>
      </div>
    </div>
  );
