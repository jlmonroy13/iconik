...
export const metadata: Metadata = {
  ...
  description:
    'Configura los ajustes de tu spa de uñas, incluyendo información del negocio y preferencias.',
};
...
export default async function SettingsPage() {
  ...
  const salesGoals = salesGoalsResult.success
    ? salesGoalsResult.data || []
    : [];
              ...
              <Card>
                <CardHeader>
                  ...
                  <p className='text-sm text-gray-500 dark:text-gray-400 mt-1'>
                    Actualiza el nombre, la dirección y la información de
                    contacto de tu spa.
                  </p>
                </CardHeader>
                <CardContent>
            ...
            <FadeIn delay={300}>
              <Card>
                <CardHeader>
                  ...
                  <p className='text-sm text-gray-500 dark:text-gray-400 mt-1'>
                    Configura los horarios de apertura y cierre de tu spa para
                    cada día de la semana y festivos.
                  </p>
                </CardHeader>
            ...
            <FadeIn delay={400}>
              <Card>
                <CardHeader>
                  ...
                  <p className='text-sm text-gray-500 dark:text-gray-400 mt-1'>
                    Configura metas de ingresos, servicios, clientes y citas
                    para tu spa.
                  </p>
                </CardHeader>
                <CardContent className='space-y-6'>
                ...
                <CardContent>
                  <div className='p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg'>
                    ...
                    <p className='text-blue-600 dark:text-blue-300 text-xs mt-1'>
                      Próximamente podrás configurar notificaciones por email,
                      SMS y push.
                    </p>
                  </div>
                </CardContent>
            ...
            <FadeIn delay={600}>
              <Card>
                <CardHeader>
                  ...
                  <p className='text-sm text-gray-500 dark:text-gray-400 mt-1'>
                    Configura preferencias de zona horaria, moneda y formato de
                    fechas.
                  </p>
                </CardHeader>
                <CardContent>
                  <div className='p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg'>
                    ...
                    <p className='text-blue-600 dark:text-blue-300 text-xs mt-1'>
                      Próximamente podrás configurar zona horaria, moneda y
                      otros ajustes.
                    </p>
                  </div>
                </CardContent>
