...
export function ServiceFiltersPanel({
  ...
  const updateFilter = (key: keyof ServiceFilters, value: string | boolean | undefined) => {
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-3">
        ...
        <div>
          <Select
            ...
            label="Estado"
            labelAdornment={filters.isActive !== undefined && (<span className="ml-1 text-pink-600 dark:text-pink-400">●</span>)}
          >
