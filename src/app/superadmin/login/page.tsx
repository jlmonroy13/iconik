...
import { Input, Button, Card, CardContent, useNotifications } from "@/components/ui"
...
export default function SuperAdminLoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!SUPERADMIN_EMAILS.includes(email)) {
      showError("Error", "This email is not authorized for super admin access.")
      setIsLoading(false)
      return
    }
      ...
      <div className="w-full max-w-md">
        <Card className="shadow-xl">
          <CardContent className="p-8">
            <h1 className="text-2xl font-bold text-center mb-6 text-gray-900 dark:text-white">Super Admin Login</h1>
