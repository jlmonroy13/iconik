 ...
 */
export function SpaManagementGuard({ children, spaId, fallback }: SpaGuardProps) {
 ...
 */
export function BranchAccessGuard({ children, branchId, fallback }: BranchGuardProps) {
 ...
 */
export function BranchManagementGuard({ children, branchId, fallback }: BranchGuardProps) {
 ...
 */
export function FeatureGuard({ children, feature, spaId, branchId, fallback }: FeatureGuardProps) {
 ...
 */
export function AppointmentManagementGuard({ children, spaId, branchId, fallback }: {
  children: ReactNode
  spaId: string
  branchId?: string
  fallback?: ReactNode
 ...
 */
export function ReportsGuard({ children, spaId, branchId, fallback }: {
  children: ReactNode
  spaId: string
  branchId?: string
  fallback?: ReactNode
 ...
 */
export function DianSettingsGuard({ children, spaId, fallback }: SpaGuardProps) {
 ...
 */
export function UserManagementGuard({ children, targetSpaId, fallback }: {
  children: ReactNode
  targetSpaId?: string
  fallback?: ReactNode
}) {
...
export function RoleGuard({
  ...
  children: ReactNode
  allowedRoles: ('SUPER_ADMIN' | 'SPA_ADMIN' | 'BRANCH_ADMIN' | 'MANICURIST' | 'CLIENT')[]
  fallback?: ReactNode
}) {
