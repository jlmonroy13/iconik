...
const avatarVariants = cva(
  'relative inline-flex items-center justify-center font-medium select-none shrink-0 overflow-hidden',
  {
    variants: {
      ...
      variant: {
        default:
          'text-gray-700 dark:text-gray-300 bg-gray-300 dark:bg-gray-600',
        client:
          'text-pink-700 dark:text-pink-300 bg-pink-200 dark:bg-pink-800/50',
        manicurist:
          'text-purple-700 dark:text-purple-300 bg-purple-200 dark:bg-purple-800/50',
      },
    },
    defaultVariants: {
      size: 'md',
