...
import { ServiceType, AppointmentStatus, ServiceTimeRating } from '@/generated/prisma'
...
export interface Expense {
  ...
  amount: number
  type: 'FIXED' | 'VARIABLE'
  category: 'RENT' | 'SALARIES' | 'MARKETING' | 'SUPPLIES' | 'UTILITIES' | 'INSURANCE' | 'MAINTENANCE' | 'EQUIPMENT' | 'SOFTWARE' | 'PROFESSIONAL' | 'TRAINING' | 'TRAVEL' | 'FOOD' | 'CLEANING' | 'SECURITY' | 'OTHER'
